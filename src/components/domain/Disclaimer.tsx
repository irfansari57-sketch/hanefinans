...
export const DISCLAIMER_FULL_PARAGRAPHS = [
  ...
  `InvestliQ bir yatırım kuruluşu değildir. Burada gördükleriniz herhangi bir varlık için alım/satım yönlendirici nitelikte tavsiye veya yorum niteliğinde paylaşımlar değildir; sadece yatırımcıların kendisini geliştirmesi ve bu piyasada bilinçli yatırımcıların çoğalması maksadıyla bazı banka ve aracı kurumların raporlarını ve hedef fiyatlarını paylaşmaktadır.`,
  `Finansal okuryazarlığa katkı sunmak, neye/neden yatırım yapıldığını tam manasıyla okuyabilmek için işin profesyonellerinin bakış açılarını, değerleme modellerini ve bir şirketi değerlerken dikkate aldıkları kriterleri göz önünde bulundurabilirsiniz; lakin yalnızca bu raporlar veya analizlere güvenerek yatırım yapmak sizi maddi kayıplara uğratabilir. Bu bilgiler/paylaşımlar kurum ve banka raporları olmakla birlikte InvestliQ kesinlikle alım/satım için tavsiye veya yorum yapmamaktadır ve tavsiye niteliği taşımamaktadır.`,
];
