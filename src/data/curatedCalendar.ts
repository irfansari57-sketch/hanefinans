...
export const CURATED_CALENDAR: CalendarEvent[] = [
  ...
  // ============ AĞUSTOS 2026 ============
  {
    id: 'us-jolts-jul-2026',
    date: '2026-08-25',
    time: '17:00',
    title: 'ABD Temmuz JOLTS İş İlanları',
    category: 'data',
    country: 'US',
    importance: 'medium',
    description: 'İş piyasası daralma göstergesi. FED istihdam mandatının kritik veri seti.',
    expectation: 'İlan sayısında düşüş = işten çıkarma başlangıcı sinyali.',
    impact: 'unknown',
  },
  {
    id: 'us-gdp-q2-2026',
    date: '2026-08-27',
    time: '15:30',
    title: 'ABD Q2 2026 GSYİH (İkinci Tahmin)',
    category: 'data',
    country: 'US',
    importance: 'high',
    description: 'BEA ikinci tahmin — tüketici harcaması ve şirket karları detayı.',
    expectation: 'Trend büyümenin üzerinde/altında görülmesi FED patikasını yönlendirir.',
    impact: 'unknown',
  },
  {
    id: 'us-pce-jul-2026',
    date: '2026-08-28',
    time: '15:30',
    title: 'ABD Temmuz PCE Deflatörü',
    category: 'data',
    country: 'US',
    importance: 'high',
    description: 'FED\'in favori enflasyon göstergesi. Çekirdek PCE hedef %2.',
    expectation: 'FOMC Eylül kararının en kritik girdisi.',
    impact: 'unknown',
  },
  {
    id: 'jackson-hole-2026',
    date: '2026-08-22',
    title: 'Jackson Hole Ekonomi Sempozyumu (Kansas City FED)',
    category: 'monetary',
    country: 'US',
    importance: 'high',
    description: 'Yıllık merkez bankacıları toplantısı — Powell konuşması piyasa yönlendirici.',
    expectation: 'FED indirim patikasına dair ipuçları taranır.',
    impact: 'unknown',
  },
  // ============ EYLÜL 2026 ============
  {
    id: 'us-ism-mfg-aug-2026',
    date: '2026-09-02',
    time: '17:00',
    title: 'ABD Ağustos ISM İmalat PMI',
    category: 'data',
    country: 'US',
    importance: 'medium',
    description: 'İmalat sektörü aktivite göstergesi. 50 altı daralma.',
    impact: 'unknown',
  },
  {
    id: 'us-adp-aug-2026',
    date: '2026-09-03',
    time: '15:15',
    title: 'ABD Ağustos ADP Özel Sektör İstihdam',
    category: 'data',
    country: 'US',
    importance: 'medium',
    description: 'NFP öncesi öncü gösterge (2 gün önce).',
    impact: 'unknown',
  },
  {
    ...
    date: '2026-09-04',
    time: '17:00',
    title: 'ABD Ağustos ISM Hizmetler PMI',
    category: 'data',
    country: 'US',
    importance: 'medium',
    description: 'Hizmet sektörü aktivite göstergesi. ABD ekonomisinin %70\'i hizmet.',
    impact: 'unknown',
  },
  {
    id: 'us-nfp-aug-2026',
    date: '2026-09-04',
    time: '15:30',
    title: 'ABD Ağustos Tarım Dışı İstihdam (NFP)',
    category: 'data',
    country: 'US',
    importance: 'high',
    description: 'BLS Ağustos istihdam raporu — FOMC Eylül toplantısı öncesi son NFP.',
    expectation: 'Zayıf veri → 25 bps indirim baskısı artar → DXY aşağı, altın yukarı, EM olumlu.',
    impact: 'unknown',
    proAnalysis: {
      bullishScenario: 'NFP <100k + işsizlik yukarı — indirim %90 fiyatlanır, risk varlıklar rali, altın 5000$ üstü.',
      baseScenario: 'NFP 150k civarı — pariteler yatay, indirim belirsizliği devam.',
      bearishScenario: 'NFP >250k + ücret enflasyonu yukarı — indirim gecikir, DXY güçlü, EM baskı.',
      bistImpact: 'DXY üzerinden dolaylı: güçlü NFP → DXY yukarı → USDTRY yukarı baskı → BIST negatif.',
      usdtryImpact: 'Karar sonrası ilk 30 dk yüksek volatilite.',
      goldImpact: 'Zayıf NFP altın için pozitif; güçlü NFP altın satışı.',
      watchlist: ['DXY', 'GLD', 'SPY', 'USDTRY', 'XAUUSD'],
    },
  },
  {
    id: 'us-cpi-aug-2026',
    date: '2026-09-10',
    time: '15:30',
    title: 'ABD Ağustos TÜFE',
    category: 'data',
    country: 'US',
    importance: 'high',
    description: 'BLS tüketici enflasyonu; FOMC bir hafta sonra.',
    expectation: 'Çekirdek TÜFE beklenti üzeri → indirim gecikir → DXY güçlenir.',
    impact: 'unknown',
  },
  {
    id: 'us-ppi-aug-2026',
    date: '2026-09-11',
    time: '15:30',
    title: 'ABD Ağustos ÜFE (PPI)',
    category: 'data',
    country: 'US',
    importance: 'medium',
    description: 'Üretici enflasyonu — TÜFE bir gün sonra teyit veya sürpriz.',
    impact: 'unknown',
  },
  {
    id: 'tcmb-2026-09',
    date: '2026-09-11',
    time: '14:00',
    title: 'TCMB PPK Faiz Kararı (Eylül)',
    category: 'monetary',
    country: 'TR',
    importance: 'high',
    description: 'TCMB 2026 Eylül PPK toplantısı — politika faizi kararı.',
    expectation: 'Ağustos TÜFE\'ye bağlı ölçülü indirim veya sabit tutulma.',
    impact: 'unknown',
  },
  {
    id: 'us-retail-sales-aug-2026',
    date: '2026-09-16',
    time: '15:30',
    title: 'ABD Ağustos Perakende Satışları',
    category: 'data',
    country: 'US',
    importance: 'high',
    description: 'FOMC günü açıklanır — kritik tüketici talebi göstergesi.',
    impact: 'unknown',
  },
  {
    id: 'fomc-2026-09',
    date: '2026-09-17',
    time: '21:00',
    title: 'FED FOMC Faiz Kararı + SEP + Dot Plot',
    category: 'monetary',
    country: 'US',
    importance: 'high',
    description: 'FOMC ikinci günü — faiz + güncel ekonomik projeksiyonlar (SEP) + dot plot. Powell 21:30 basın.',
    expectation: '25 bps indirim baz senaryo; dot plot revizyonu kritik.',
    impact: 'unknown',
    proAnalysis: {
      bullishScenario: '25 bps indirim + güvercin dot plot (3 indirim daha) — risk rali, altın rekor, EM güçlü.',
      baseScenario: '25 bps indirim + dot plot değişmez — beklendiği için sınırlı tepki.',
      bearishScenario: 'İndirim yok veya şahin dot plot — DXY yukarı, ABD tahvili tırmanır, EM zayıf.',
      bistImpact: 'Dolaylı: DXY üzerinden USD/TRY etkisi.',
      usdtryImpact: 'DXY yönüne bağlı %0.5-2 hareket.',
      goldImpact: 'Güvercin FED → altın pozitif; şahin → altın satışı.',
      watchlist: ['DXY', 'TLT', 'GLD', 'SPY', 'XU100', 'USDTRY'],
    },
  },
  {
    ...
    date: '2026-09-19',
    time: '06:00',
    title: 'BoJ Para Politikası Kararı',
    category: 'monetary',
    country: 'GLOBAL',
    importance: 'medium',
    description: 'Japon Merkez Bankası — JPY carry trade ve global likidite etkisi.',
    impact: 'unknown',
  },
  {
    id: 'viop-eylul-vade-2026',
    date: '2026-09-30',
    time: '18:10',
    title: 'VİOP Eylül 2026 Vade Sonu',
    category: 'derivatives',
    country: 'TR',
    importance: 'medium',
    description: 'BIST 30, USD/TRY ve diğer Eylül 2026 vadeli kontratların son işlem günü.',
    impact: 'neutral',
  },
  // ============ EKİM 2026 ============
  {
    id: 'us-ism-mfg-sep-2026',
    date: '2026-10-01',
    time: '17:00',
    title: 'ABD Eylül ISM İmalat PMI',
    category: 'data',
    country: 'US',
    importance: 'medium',
    impact: 'unknown',
  },
  {
    ...
    date: '2026-10-02',
    time: '15:30',
    title: 'ABD Eylül Tarım Dışı İstihdam (NFP)',
    category: 'data',
    country: 'US',
    importance: 'high',
    description: 'BLS Eylül istihdam raporu.',
    impact: 'unknown',
  },
  {
    id: 'us-cpi-sep-2026',
    date: '2026-10-15',
    time: '15:30',
    title: 'ABD Eylül TÜFE',
    category: 'data',
    country: 'US',
    importance: 'high',
    description: 'FOMC Ekim toplantısı öncesi kritik enflasyon.',
    impact: 'unknown',
  },
  {
    id: 'us-retail-sales-sep-2026',
    date: '2026-10-16',
    time: '15:30',
    title: 'ABD Eylül Perakende Satışları',
    category: 'data',
    country: 'US',
    importance: 'high',
    impact: 'unknown',
  },
  {
    ...
    date: '2026-10-23',
    time: '14:00',
    title: 'TCMB PPK Faiz Kararı (Ekim)',
    category: 'monetary',
    country: 'TR',
    importance: 'high',
    description: 'TCMB 2026 Ekim PPK toplantısı.',
    impact: 'unknown',
  },
  {
    id: 'us-gdp-q3-2026',
    date: '2026-10-29',
    time: '15:30',
    title: 'ABD Q3 2026 GSYİH (Öncü)',
    category: 'data',
    country: 'US',
    importance: 'high',
    description: 'BEA öncü tahmin — Q3 büyüme oranı.',
    impact: 'unknown',
  },
  {
    id: 'fomc-2026-10',
    ...
    country: 'US',
    importance: 'high',
    description: 'FOMC Ekim toplantısı ikinci günü — Powell basın 21:30.',
    impact: 'unknown',
  },
  {
    id: 'us-pce-sep-2026',
    date: '2026-10-30',
    time: '15:30',
    title: 'ABD Eylül PCE Deflatörü',
    category: 'data',
    country: 'US',
    importance: 'high',
    description: 'FED çekirdek enflasyon göstergesi.',
    impact: 'unknown',
  },
  // ============ ABD TAHVİL İHALELERİ ============
  {
    id: 'us-10y-auction-aug-2026',
    date: '2026-08-26',
    time: '20:00',
    title: 'ABD 10 Yıllık Tahvil İhalesi',
    category: 'data',
    country: 'US',
    importance: 'medium',
    description: 'ABD Hazine 10Y tahvil satışı. Bid-to-cover ve indirekt talep izlenir.',
    expectation: 'Zayıf ihale = 10Y getiri yukarı = DXY yukarı = risk varlıklar baskı.',
    impact: 'unknown',
  },
  {
    id: 'us-30y-auction-aug-2026',
    date: '2026-08-27',
    time: '20:00',
    title: 'ABD 30 Yıllık Tahvil İhalesi',
    category: 'data',
    country: 'US',
    importance: 'medium',
    description: 'ABD Hazine 30Y tahvil satışı.',
    impact: 'unknown',
  },
  {
    id: 'us-10y-auction-sep-2026',
    date: '2026-09-10',
    time: '20:00',
    title: 'ABD 10 Yıllık Tahvil İhalesi (Eylül)',
    category: 'data',
    country: 'US',
    importance: 'medium',
    description: 'ABD Hazine 10Y tahvil satışı — FOMC öncesi.',
    impact: 'unknown',
  },
  {
    id: 'us-30y-auction-sep-2026',
    date: '2026-09-11',
    time: '20:00',
    title: 'ABD 30 Yıllık Tahvil İhalesi (Eylül)',
    category: 'data',
    country: 'US',
    importance: 'medium',
    impact: 'unknown',
  },
  // ============ EK ABD İSTİHDAM/ÜCRET/ENFLASYON VERİLERİ ============
  {
    id: 'us-jobless-claims-recurring',
    date: '2026-08-28',
    time: '15:30',
    ...
    country: 'US',
    importance: 'medium',
    description: 'Her Perşembe 15:30\'da açıklanan haftalık işsizlik başvuruları. 4-hafta ortalama izlenir.',
    impact: 'unknown',
  },
  {
    ...
    date: '2026-08-25',
    time: '17:00',
    title: 'ABD Ağustos Tüketici Güveni (Conference Board)',
    category: 'data',
    country: 'US',
    importance: 'medium',
    impact: 'unknown',
  },
  {
    ...
    date: '2026-09-29',
    time: '17:00',
    title: 'ABD Eylül Tüketici Güveni',
    category: 'data',
    country: 'US',
    importance: 'medium',
    impact: 'unknown',
  ...
  // ============ TCMB EK VERİLER ============
  {
    ...
    date: '2026-08-29',
    time: '14:30',
    title: 'TCMB Ağustos Enflasyon Raporu Sunumu',
    category: 'monetary',
    country: 'TR',
    importance: 'medium',
    description: 'TCMB Başkanı Karahan 2026 yıl sonu ve 2027 enflasyon tahminlerini güncelleyebilir.',
    impact: 'unknown',
  },
  {
    id: 'tr-cari-jun-2026',
    date: '2026-08-11',
    time: '10:00',
    title: 'Türkiye Haziran Cari İşlemler Dengesi',
    category: 'data',
    country: 'TR',
    importance: 'medium',
    description: 'TCMB cari işlemler açığı / fazlası.',
    impact: 'unknown',
  },
  {
    id: 'tr-cari-jul-2026',
    date: '2026-09-11',
    time: '10:00',
    title: 'Türkiye Temmuz Cari İşlemler Dengesi',
    category: 'data',
    country: 'TR',
    importance: 'medium',
    impact: 'unknown',
